...
- [ ] リファクタリング
  - [x] チェックボックスの機能をコンポーネント化
  - [x] 買い物かごアイコンの機能をコンポーネント化
  - [x] 在庫あり商品と在庫なし商品をコンポーネント化
  - [x] 購入日用DatePickerをコンポーネント化
  - [x] 税込/税別表示切替機能をコンポーネント化
  - [x] DailyとMonthlyコンポーネント内の重複している処理をリファクタリング
  - [x] 日別集計の消費品目リストをコンポーネント化
  - [x] 月別、日別集計の内訳計算をコンポーネント化
  - [x] 在庫データを取得するgetStocksをZustandで状態管理

- [x] 在庫0の商品は在庫リストの価格入力欄のプレースホルダーに価格を表示する

- [x] カテゴリー内に登録商品が無い場合「商品がありません」などのメッセージ表示させる
